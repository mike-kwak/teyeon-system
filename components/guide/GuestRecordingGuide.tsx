...
const ITEMS: ShootItem[] = [
  ...
  },
  {
    ...
    realSave: true,
    flow: [
      '게스트 신청 목록(검토 대기 우선)', '전화번호 마스킹 확인', '신청 상세 열기',
      '승인 / 보류 / 거절 선택', '운영진 메모 저장', 'Guest Pass 활성 상태 확인',
      'Guest Pass 링크 복사', '카카오 안내문 복사', '승인 게스트 KDK 후보 확인',
    ],
    narration: [
      '검토 대기 신청이 가장 먼저 보이도록 정렬됩니다.',
      '승인 시 모집 정원을 서버가 최종 검증합니다.',
      '승인 게스트는 KDK 후보로만 제공되며, 자동 등록되지 않습니다.',
    ],
    cautions: [...COMMON_CAUTIONS, '승인·보류·거절·메모는 실제 저장이 발생합니다(감사 필드 기록).'],
  },
];
