    ...
    <main className="min-h-screen bg-gradient-to-br from-[#0a0a0b] via-[#121214] to-[#0a0a0b] text-white font-sans w-full relative pb-40 overflow-x-hidden">
      ...
      <div className="px-6 pt-10 space-y-8 max-w-lg mx-auto w-full">
        ...
        <Link href="/kdk" className="block group">
          <div className="relative min-h-[180px] h-auto rounded-[28px] p-8 flex flex-col justify-between overflow-hidden bg-[#1A1C20] border-2 border-[#C9B075]/40 shadow-[0_20px_80px_rgba(0,0,0,0.6),0_0_40px_rgba(201,176,117,0.05)] active:scale-95 transition-all cursor-pointer">
            ...
            <div className="flex items-start justify-between relative z-10 gap-4">
              ...
              <div className="w-14 h-14 shrink-0 bg-[#C9B075]/20 rounded-[20px] flex items-center justify-center border border-[#C9B075]/30 shadow-[inset_0_0_20px_rgba(201,176,117,0.1)] group-hover:scale-110 transition-transform mt-1">
