...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#121212] px-5 pt-0 pb-[180px] w-full flex flex-col items-center overflow-x-hidden relative">
      <div className="w-full max-w-[430px] mx-auto flex flex-col items-center">
        
        {/* Luxury Skeleton Loading State */}
        {isLoading && (
          <div className="w-full flex flex-col gap-6 animate-pulse mt-12">
        ...
        {!isLoading && !user && (
          <div className="w-full flex flex-col items-center justify-center min-h-[40vh] px-6 py-12 mt-12 bg-gradient-to-b from-[#1A1A1A]/90 to-[#121212]/80 backdrop-blur-2xl rounded-[32px] border border-white/5 shadow-[0_20px_40px_rgba(0,0,0,0.8),inset_0_1px_0_rgba(255,255,255,0.1)] relative overflow-hidden">
        ...
        {!isLoading && user && (
          <div className="grid grid-cols-2 gap-4 w-full mt-12 animate-in slide-in-from-bottom-4 duration-700">
